...
type PostTemplateQuery = { readonly mdx: { readonly body: string | null, readonly id: string, readonly frontmatter: { readonly category: string | null, readonly date: string | null, readonly description: string | null, readonly title: string | null, readonly featuredImage: { readonly childrenImageSharp: ReadonlyArray<{ readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null> | null } | null } | null } | null };
